/**
 * SWURV-branded email shell (frontend copy).
 *
 * Mirrors apps/OpenSignServer/swurvEmail.js. They are separate bundles and cannot
 * share a module, so the two must be kept in sync by hand -- see NOTICE-swurv.md.
 *
